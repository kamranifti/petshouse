...
<div class="card">
            <div class="card-body">
              <!-- Default Tabs -->
              <ul class="nav nav-tabs yate" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <button class="nav-link" id="info-tab" data-bs-toggle="tab" data-bs-target="#info" type="button" role="tab" aria-controls="info" aria-selected="true">Info</button>
                </li>
              </ul>
              <div class="tab-content pt-2" id="myTabContent">
                ...
                <div class="tab-pane fade" id="info" role="tabpanel" aria-labelledby="contact-tab">
                  Saepe animi et soluta ad odit soluta sunt. Nihil quos omnis animi debitis cumque. Accusantium quibusdam perspiciatis qui qui omnis magnam. Officiis accusamus impedit molestias nostrum veniam. Qui amet ipsum iure. Dignissimos fuga tempore dolor.
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam explicabo, aut eligendi harum amet pariatur quos rem numquam animi, doloribus nihil excepturi reiciendis similique voluptatibus veniam maiores non deleniti minus.
                </div>
